  ...
  translation: {
    ...
    features: {
      ...
      methods: {
        ...
        description: "Aprenda técnicas de Stanislavski, Brecht e Chekhov."
      }
    },
    process: {
      title: "Como Funciona",
    ...
    whyUse: {
      ...
      character: {
        ...
        description: "Aprenda imersão de personagem como Marlon Brando"
      },
      scene: {
        title: "Análise de Cena",
        description: "Estude técnicas de análise de cena de Meryl Streep"
      }
    },
    oscarWinners: {
